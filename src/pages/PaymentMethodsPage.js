...
import mbway from '../assets/images/PaymentMethodsPage/mbway.png';
import applepay from '../assets/images/PaymentMethodsPage/applepay.png';
import paypal from '../assets/images/PaymentMethodsPage/paypal.png';
import bitcoin from '../assets/images/PaymentMethodsPage/bitcoin.png';
        ...
        return (
            <Grid container>
                ...
                <Grid item xs={6} align='left' paddingLeft='2vh'>
                    <MethodButton text={t('paymentMethods.button.card')} image={card} action={goto('card', {
                        prev_page: prev_page,
                        price: price
                    })} />
                </Grid>
                ...
                <Grid container position='absolute' bottom='1vh' width='54.25vh' alignItems='center'>
                    <Grid item xs={4} align='left'>
                        <BackButton text={t('button.back')} back={goto('nif', {
                            prev_page: prev_page,
                            price: price
                        })} />
                    </Grid>
